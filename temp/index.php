...
<body>
    ...
    <form action="info.php" method="POST">
        (1) 예산
        <input type="int" name="min_price" placeholder="최소 예산 입력(숫자만)">
        <input type="int" name="max_price" placeholder="최대 예산 입력(숫자만)">
        <br>
        (2) 지역
        <select name="gu">
        ...
        <br>
        (3) 평수
        <input type="int" name="min_size" placeholder="최소 평수 입력(숫자만)">
        <input type="int" name="max_size" placeholder="최대 평수 입력(숫자만)">
        <br>
