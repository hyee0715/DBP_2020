...
if ($_POST['cuisine'] == "" && $_POST['transport'] == "" && $_POST['drink'] == "") {
    $query = "SELECT user_profile.userID, user_cuisine.Ucuisine, 
    user_payment.Upayment, user_profile.smoker, user_profile.drink_level, 
    user_profile.transport, user_profile.budget, user_profile.birth_year, 
    res_location.name, res_cuisine.Rcuisine
    FROM user_profile
    JOIN user_cuisine
...
} elseif ($_POST['transport'] == "" && $_POST['drink'] == "") {
    $filtered = array(
    ...
    JOIN res_cuisine
    ON res_location.placeID = res_cuisine.placeID
    WHERE user_cuisine.Ucuisine = '{$filtered['cuisine']}'
    ";
} elseif ($_POST['cuisine'] == "" && $_POST['drink'] == "") {
    $filtered = array(
        'transport' => mysqli_real_escape_string($link, $_POST['transport'])
      );
    ...
    JOIN res_cuisine
    ON res_location.placeID = res_cuisine.placeID
    WHERE user_profile.transport = '{$filtered['transport']}'
    ";
} elseif ($_POST['cuisine'] == "" && $_POST['transport'] == "") {
    $filtered = array(
        'drink' => mysqli_real_escape_string($link, $_POST['drink'])
      );
    ...
    JOIN res_cuisine
    ON res_location.placeID = res_cuisine.placeID
    WHERE user_profile.drink_level = '{$filtered['drink']}'
    ";
    ...
    ON res_location.placeID = res_cuisine.placeID
    WHERE user_profile.drink_level = '{$filtered['drink']}'
    AND user_profile.transport = '{$filtered['transport']}'
    ";
} elseif ($_POST['drink'] == "") {
    $filtered = array(
        'cuisine' => mysqli_real_escape_string($link, $_POST['cuisine']),
    ...
    ON res_location.placeID = res_cuisine.placeID
    WHERE user_cuisine.Ucuisine = '{$filtered['cuisine']}'
    AND user_profile.drink_level = '{$filtered['drink']}'
    ";
} else {
    $filtered = array(
        'cuisine' => mysqli_real_escape_string($link, $_POST['cuisine']),
