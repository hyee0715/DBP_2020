...
if ($_POST['cuisine'] == "" && $_POST['price'] == "" && $_POST['drink'] == "") {
...
} elseif ($_POST['price'] == "" && $_POST['drink'] == "") {
    $filtered = array(
    ...
    $filtered = array(
      ...
      $query = "SELECT res_payment.placeID, res_location.name, res_cuisine.Rcuisine, res_hours.days, 
        ...
        JOIN res_parking
        ON res_parking.placeID = res_location.placeID
        WHERE res_location.price = '{$filtered['price']}'
        ORDER BY res_location.placeID";
} elseif ($_POST['cuisine'] == "" && $_POST['price'] == "") {
    $filtered = array(
      ...
      $query = "SELECT res_payment.placeID, res_location.name, res_cuisine.Rcuisine, res_hours.days, 
        ...
        JOIN res_parking
        ON res_parking.placeID = res_location.placeID
        WHERE res_location.alcohol = '{$filtered['drink']}'
        ORDER BY res_location.placeID";
    ...
    $filtered = array(
      ...
      $query = "SELECT res_payment.placeID, res_location.name, res_cuisine.Rcuisine, res_hours.days, 
        ...
        ON res_parking.placeID = res_location.placeID
        WHERE res_location.price = '{$filtered['price']}'
        AND res_location.alcohol = '{$filtered['drink']}'
        ORDER BY res_location.placeID";
} elseif ($_POST['drink'] == "") {
    $filtered = array(
        'cuisine' => mysqli_real_escape_string($link, $_POST['cuisine']),
      ...
      $query = "SELECT res_payment.placeID, res_location.name, res_cuisine.Rcuisine, res_hours.days, 
        ...
        ON res_parking.placeID = res_location.placeID
        WHERE res_cuisine.Rcuisine = '{$filtered['cuisine']}' 
        AND res_location.price = '{$filtered['price']}'
        ORDER BY res_location.placeID";
} elseif ($_POST['price'] == "") {
    $filtered = array(
        'cuisine' => mysqli_real_escape_string($link, $_POST['cuisine']),
